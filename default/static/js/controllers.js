...
conferenceApp.controllers.controller('CreateConferenceCtrl',
    function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
        ...
        $scope.populateConference = function () {
            window.duplicate = window.duplicate || 0;
            var confs = [
                {"alt": "json", 
                "name": "Primero - " + window.duplicate, 
                "city": "Chicago", 
